  ...
  return (
    <div className="w-full bg-[#1b1b1b] border-t-4 border-white px-4 py-3 text-white">
      <div className="flex items-start gap-3">
        {/* 顔アイコン枠：あとでSDキャラ画像に差し替える場所 */}
        <div className="w-14 h-14 rounded-lg border-2 border-white bg-[#2b2b2b] flex-shrink-0 flex items-center justify-center text-xs text-gray-300">
          顔
        </div>
