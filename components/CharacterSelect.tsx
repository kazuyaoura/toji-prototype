// components/CharacterSelect.tsx  ← Tailwind版（v10-tw 安定化）
'use client';
      ...
      <main className="w-full max-w-[720px] px-3">
        ...
        <div className="relative mx-auto grid w-full max-w-[680px] grid-cols-2 gap-4 place-items-center">
          ...
          <div className="w-full flex flex-col items-center">
            ...
            {/* 画像枠：幅基準＋max幅/高で顔ドアップ防止 */}
            <div className="w-[44vw] max-w-[200px] max-h-[220px] overflow-hidden
                            flex items-center justify-center bg-white/60 rounded-xl shadow">
              <img
            ...
            <button
              type="button"
              onClick={() => onSelect('隆介')}
              className="w-full max-w-[280px] mt-2 px-4 py-3 rounded-xl font-bold text-white
                         bg-blue-600 hover:bg-blue-700 active:translate-y-[1px] shadow"
            >
              ▶ 隆介を選ぶ
            </button>
          </div>
